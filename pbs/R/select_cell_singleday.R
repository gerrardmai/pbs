...
select_cell_singleday=function(count_data=NULL,count_logdata=NULL,pca_k=NULL,cell_anno=NULL, pca_method="varianceplot",cluster_method="kmeans",center_method="snn_search",k1=NULL,clustern=4)
{
  ...
  r2=foreach(j=unique(sub_cluster_lab),
             .combine = rbind,
